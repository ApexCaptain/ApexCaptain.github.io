...
만일 텍스트로만 이루어진 어떤 문서의 글자 수가 5,000개이고, 이 5,000개가 한 덩어리로 Vector에 저장되어  
있다면 LLM은 엄청난 크기의 Context에 부담을 지게 될 것이다. <sub>(혹은 당신의 지갑이...)</sub>
