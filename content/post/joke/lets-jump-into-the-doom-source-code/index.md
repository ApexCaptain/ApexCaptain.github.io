...
# DOOM
1993년 12월 10일에 발매된 이 게임은 FPS라는 게임 장르의 기본적인 플레이 방법을 문자 그대로 **정립**했다 라는 평가를 받고 있다.

개발자들 사이에서 유독 더 인기가 많은데, 이는 오리지널 소스코드를 모두 [깃허브](https://github.com/id-Software/DOOM)에 공개하는 대범한 행보를 보였던 까닭이다.
